                ...
                <table class="w-full border-collapse text-left text-xs">
                    <thead class="bg-gray-100 text-gray-700">
                        <tr>
                            ...
                            <th class="p-3 font-semibold">Profile picture</th>
                            <th class="p-3 font-semibold">Specification</th>
                            {/* For Big text and small text about the user profile */}
                            <th class="p-3 font-semibold">BigText</th>
                            <th class="p-3 font-semibold">SmallText</th>
                            <th class="p-3 font-semibold">ResumePath</th>
                    ...
                    <tbody>
                        <tr class="border-b">
                            <td class="p-3">1</td>
                            <td class="p-3">Shiba Murmu</td>
                            <td class="p-3">/admin/profile</td>
