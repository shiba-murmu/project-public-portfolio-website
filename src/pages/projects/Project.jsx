...
function Project() {
    return (
        <>
            <div id='project' className='min-h-screen pt-20 bg-(--about-bg) flex  justify-start items-start text-4xl font-bold text-(--text-primary) flex-col'>
                ...
                <div className='md:hidden w-full flex flex-col md:flex-row justify-center items-center'>
                    <div className='md:hidden bg-white h-80  rounded-md shadow-md m-4'>
                        <div className='p-4'>
