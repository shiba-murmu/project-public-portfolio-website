...
export default function Profile() {
    ...
    // initialize AOS (you already have this hook)
    ...
    const skills = ['Python', 'JavaScript', 'React', 'Tailwind']
        ...
        <section id="home" className="min-h-screen flex items-center py-8 md:py-16">
            <div className="w-[90%] md:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <aside className="flex flex-col items-center md:items-start gap-6 order-1 md:order-1">
                    <div
                        className="relative rounded-md overflow-hidden w-40 h-40 md:w-72 md:h-72 border border-(--border-color) shadow-sm"
                        data-aos="zoom-in"
                    ...
                    <div className="text-center md:text-left">
                        <h1 data-aos="fade-up" data-aos-delay="80" className="text-2xl md:text-4xl font-extrabold">
                            {name} <span className="block md:inline">{lastName}</span>
                        </h1>
                        <p data-aos="fade-up" data-aos-delay="160" className="text-(--muted-text) mt-1">{profession}</p>
                    </div>

                    <div className="flex gap-3" data-aos="fade-up" data-aos-delay="220">
                        <button
                    ...
                    <div className="flex flex-wrap gap-2 mt-2 md:hidden" data-aos="fade-up" data-aos-delay="300">
                        {['React', 'Tailwind', 'JS'].map((s, i) => (
                            <span key={s} className="px-3 py-1 rounded-full text-xs bg-[rgba(255,255,255,0.02)] border border-(--border-color)" data-aos="fade-right" data-aos-delay={320 + i * 80}>
                                {s}
                            </span>
                        ))}
                    </div>
                ...
                <main className="order-2 md:order-2">
                    <div className="max-w-xl">
                        <p data-aos="fade-up" data-aos-delay="120" className="text-lg md:text-2xl leading-relaxed text-center md:text-left text-(--muted-text)">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200" className="mt-4 text-(--muted-text) text-center md:text-left">
                        ...
                        <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start" data-aos="fade-up" data-aos-delay="260">
                            <a href="/" className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-(--button-background) text-(--button-text-color) font-medium">
                                Resume
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            {skills.map((k, i) => (
                                <div
                                    key={k}
                                    className="flex items-center gap-3 p-3 rounded-lg bg-[rgba(255,255,255,0.02)] border border-(--border-color)"
                                    data-aos="fade-up"
                                    data-aos-delay={320 + i * 100}
                                >
                        ...
                        {/* social row */}
                        <div className="mt-6 flex gap-4 justify-center md:justify-start" data-aos="fade-up" data-aos-delay="420">
                            <a href="" className="p-2 rounded-full hover:bg-[rgba(255,255,255,0.02)] border border-(--border-color)" data-aos="zoom-in" data-aos-delay="440">
                                {/* Facebook */}
                            ...
                            <a href="" className='p-2 rounded-full hover:bg-[rgba(255,255,255,0.02)] border border-(--border-color)' data-aos="zoom-in" data-aos-delay="480">
                                {/* LinkedIn */}
                            ...
                            <a href="" className="p-2 rounded-full hover:bg-[rgba(255,255,255,0.02)] border border-(--border-color)" data-aos="zoom-in" data-aos-delay="520">
                                {/* GitHub */}
