...
import img from '../../assets/images/bhawna_profile.jpg'
import { portfolioInfo } from '../../hooks/detailed_data.js'
export default function Profile() {
    ...
    useEffect(() => {
        setName(portfolioInfo.firstname)
        setLastName(portfolioInfo.lastname)
        setProfession(portfolioInfo.title)
    }, [])
                ...
                <main className="order-2 md:order-2">
                    <div className="max-w-xl">
                        ...
                        <div className="mt-6 flex gap-4 justify-center md:justify-start" data-aos="fade-up" data-aos-delay="420">
                            ...
                            <a
                                href="https://www.linkedin.com/in/bhawna-choudhary-92065a258"
                                target="_blank"
