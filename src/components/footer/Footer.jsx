...
function Footer() {
    return (
        <>
            <div id='Footer' className=' md:rounded-t-4xl md:flex md:flex-col md:gap-20  bg-(--footer-background) md:p-30 md:pb-10'>
                <div className='md:grid md:grid-cols-2 md:justify-center md:content-start'>
                    <div className='md:flex md:flex-col md:gap-3'>
                        ...
                        <section className='md:mt-4'>
                            <span className='border p-3 rounded-full px-10 border-dashed'>shibamurmu001@gmail.com</span>
                        </section>
                    </div>
                    <div className='md:grid md:grid-cols-2 md:justify-center md:content-start'>
                        <div>
                ...
                <div className='border-t border-(--muted-text) md:pt-10 md:grid md:grid-cols-2'>
