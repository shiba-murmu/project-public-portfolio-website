...
function CustomHeader() {
    return (
        <>
            <div  className='sticky top-0 z-50 flex justify-between bg-(--bluish) items-center shadow-md'>
                <div className='py-3 md:py-4 pl-3 md:pl-15 text-yellow-600 text-2xl heading-text'>Shiba Murmu</div>
